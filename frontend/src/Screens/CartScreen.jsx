  ...
  return (
    <Row>
        ...
        <ListGroup variant='flush'>
                ...
                {cartItems.length > 0 && (
                <>
                <ListGroup.Item style={{ borderBottom: 'none', display: 'flex', justifyContent: 'space-between'}}>
                    Items Price: <span>${cart.itemsPrice}</span>
                </ListGroup.Item>
                <ListGroup.Item style={{border: 'none', display: 'flex', justifyContent: 'space-between'}}>
